	...
	<article id="livro-css-eficiente">
		...
		<div class="container">
			...
			<section class="data product-detail">
				...
				<p></p>
				<fmt:parseDate value="${produto.dataLancamento }" type="date" pattern="yyyy-MM-dd" var="parsedDate"/>
				<p>Data de publicação: <fmt:formatDate value="${parsedDate }" pattern="dd/MM/yyyy" /></p>				
				<p>
